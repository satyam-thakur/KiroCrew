 ...
 *
 * The renderer is told a COUNT and a TIME and nothing else. Paths, filenames and
 * exception codes stay in the main process (see `crashNoticeSummary` in
...
type CrashReportsAPI = {
  get(): Promise<{ newCount: number; lastCrashAt: string | null; hasLog: boolean }>
